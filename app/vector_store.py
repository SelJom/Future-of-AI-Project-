...
def get_vector_store():
    ...
    # 2. CORRECTION DU BUG CPU : On retire les arguments complexes qui font planter torch
    # On laisse la librairie détecter le CPU automatiquement.
    embedding_func = HuggingFaceEmbeddings(
        model_name=Config.EMBEDDING_MODEL_NAME
        # On a retiré model_kwargs={'device': 'cpu'} qui causait l'erreur "meta tensor"
    )
